...
if (loadFile)
{
    ...
    if (saveMap != -1)  //check if the save map loaded correctly
    {
        ...
        global.savePlayerDot = ds_map_find_value(saveMap,"savePlayerDot");
        global.savePlayerAngle = ds_map_find_value(saveMap,"savePlayerAngle");
        global.saveGrav = ds_map_find_value(saveMap,"saveGrav");
        global.saveXGrav = ds_map_find_value(saveMap,"saveXGrav");
...
global.noRestart = false;   //disable no restart mode
global.noShoot = false;     //disable no shoot mode
