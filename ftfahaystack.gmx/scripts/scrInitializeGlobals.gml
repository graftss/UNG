...
global.noRestart = false;       //sets whether or not to allow restarting (useful for transitions)
global.noShoot = false;         //sets whether or not to allow shooting (useful for transitions)
