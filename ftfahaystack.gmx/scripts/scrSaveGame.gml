...
{   
    ...
    if (instance_exists(objPlayer))
    {
        ...
        global.savePlayerDot = global.dotKid;
    ...
    {
        global.savePlayerX = (objPlayerStart.x + 17);
        global.savePlayerY = (objPlayerStart.y + 23);
        global.savePlayerX = floor(global.savePlayerX);
        global.savePlayerY = floor(global.savePlayerY);
    }
    global.savePlayerAngle = global.playerAngle;
    global.saveGrav = global.grav;
    global.saveXGrav = global.Xgrav;
...
ds_map_add(saveMap,"savePlayerDot",real(global.savePlayerDot));
ds_map_add(saveMap,"savePlayerAngle",global.savePlayerAngle);
ds_map_add(saveMap,"saveGrav",global.saveGrav);
ds_map_add(saveMap,"saveXGrav",real(global.saveXGrav));
